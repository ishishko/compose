...
RUN git clone -b 17.0 --single-branch https://github.com/ingadhoc/odoo-argentina.git /mnt/extra-addons/ingadhoc/odoo-argentina \
    ...
    && git clone -b 17.0 --single-branch https://github.com/ntsystemwork/hito-adhoc-stock.git /mnt/extra-addons/ingadhoc/stock \
    && git clone -b 17.0 --single-branch https://github.com/ntsystemwork/hito-ingadhoc-account-financial-tools.git /mnt/extra-addons/ingadhoc/account-financial-tools
