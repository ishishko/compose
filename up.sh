...
git clone -b 17.0 https://github.com/odoomates/odooapps.git ./odoo-addons/source/basic
...
# docker exec -it odoo17 bash -c "find /mnt/extra-addons/ -name requirements.txt -exec pip install -r {} \;"
